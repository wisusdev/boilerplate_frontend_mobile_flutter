...
class _UserEditState extends State<UserEdit> {
  ...
  void _initializeFields() {
    if (_user != null) {
      _usernameController.text = _user!.attributes.username;
      _firstNameController.text = _user!.attributes.firstName;
      _lastNameController.text = _user!.attributes.lastName;
      _emailController.text = _user!.attributes.email;
      _selectedRoles = List<String>.from(_user!.relationships.roles);
    }
  }
  ...
  Future<void> _submitForm() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(Location.of(context)!.trans('user_updated_successfully'))),
      );
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          Location.of(context)!.trans('edit_user'),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        labelText: '${Location.of(context)!.trans('password')} (opcional)',
                        border: const OutlineInputBorder(),
                        enabled: !_isSubmitting,
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        labelText: '${Location.of(context)!.trans('password_confirmation')} (opcional)',
                        border: const OutlineInputBorder(),
                        enabled: !_isSubmitting,
