                ...
                child: Column(
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      child: Center(
                          child: Text(Location.of(context)!.trans('save'),
                              style: TextStyle(fontWeight: FontWeight.bold, fontFamily: "Sofia", color: Theme.of(context).colorScheme.onPrimary, fontSize: 18.0))),
                    ),
                    const SizedBox(height: 20),
                  ],
                ),
